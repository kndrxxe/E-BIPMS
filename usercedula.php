...
<head>
    ...
    <title>Request Cedula | E-BIPMS</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">REQUEST CEDULA</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-md btn-warning addbtn" data-bs-toggle="modal"
                                data-bs-target="#requestCedula"><i class="bi bi-file-earmark-text">
                                </i>Request
                            </button>
                        </div>
                    </div>
                    <div class="modal fade" id="requestCedula" tabindex="-1"
                        aria-labelledby="requestCedulaLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="requestCedulaLabel">Request Cedula (₱30.00)</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form class="forms needs-validation" method="POST"
                                        action="userprocesscedula.php" novalidate="">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-md" style="width:100%">
                        ...
                        <tbody>
                            ...
                            include 'conn.php';
                            $uid = $_SESSION['uid'];
                            $query = "SELECT * FROM cedula WHERE userID='$uid' ";
                            $query_run = mysqli_query($conn, $query);
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                        ...
                                        <div class="modal fade" id="updatePayment" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="forms needs-validation" method="POST"
                                                            action="usercedulapayment.php" enctype="multipart/form-data"
                                                            novalidate="">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <p class="text-center">No cedula request yet.</p>
                                    </td>
                                </tr>
                                <?php
                            }

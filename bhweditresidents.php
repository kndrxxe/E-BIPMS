...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="position-sticky pt-2 mt-2 sidebar-sticky bg-light">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item fs-7">
                            <a class="nav-link" aria-current="page" href="bhwhome.php">
            ...
            <form class="needs-validation" action="bhwupdateresidentprofile.php" method="POST" novalidate=""
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <form action="bhwupdateresidentprofile.php" method="POST" enctype="multipart/form-data">
                        <div class="text-center mb-3">
                            ...
                            <div class="form-floating mt-3 mb-1 col-12 col-md-7 col-lg-5 mx-auto"
                                ...
                                <a href="bhw_delete_picture.php?id=<?php echo $row['id'] ?>"

...
if ($result) {
  ...
  $mail->Subject = 'Your barangay identification request has been approved!';
...
<html>
  ...
  <body>
    ...
    <p style="font-family: Arial, Helvetica, sans-serif">
      We are pleased to inform you that your Barangay Identification is now ready for
  ...
  $mail->isHTML(true);
  $mail->AltBody = "Dear Resident,\n\nWe are pleased to inform you that your Barangay Identification is now ready for pick up. Please visit the Barangay Hall at your earliest convenience to collect it.\n\nPlease bring your valid ID for verification purposes. If you are acting as a representative, kindly bring your valid ID and the valid ID of the person making the request.
  \n\nThank you for your patience and understanding.\n\nBest regards,\nBrgy. Kanlurang Bukal";

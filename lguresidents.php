                ...
                <table id="myTable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($query_run) > 0) {
                            ...
                            <!-- View Modal -->
                            <div class="modal fade" id="viewModal<?= $items['id']; ?>" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                        ...
                        <div class="form-floating mt-2 mb-2" id="specialGroupDiv" style="<?php echo ($items['is_special_group'] == '1') ? '' : 'display: none;'; ?>">
                            <select class="form-select form-select" id="specialGroup" name="specialgroup" placeholder="specialgroup" disabled>
                            ...
                            <?php if ($items['specialgroup'] == 'Senior Citizen')
...
<div class="row g-2">
    <div class="form-floating col">
        <select class="form-select form-select" name="employmentstatus" value="<?php echo $items['employmentstatus'] ?>" placeholder="employmentstatus" disabled>
            <option selected disabled>Choose from options
            </option>
...
<div class="row g-2 mb-2">
    <div class="form-floating col">
        <input type="email" class="form-control rounded" value="<?= $items['email']; ?>" name="email" id="email" placeholder="someone@example.com" readonly />

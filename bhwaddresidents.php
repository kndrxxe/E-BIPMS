			...
			<form class="needs-validation" action="adminresidentsprocess.php" method="POST" novalidate="">
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					...
					<div class="d-flex flex-wrap row g-4 mb-3 gx-1 p-3  text-start">
						...
						<div class="row g-2">
							<div class="form-floating col">
								<input type="text" class="form-control rounded" maxlength="4" name="house_no"
						...
						<div class="row g-2">
							<div class="form-floating col">
								<input type="text" class="form-control" name="members" id="members" maxlength="2" min="0" max="99"
